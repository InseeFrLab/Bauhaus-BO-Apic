...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(@Value("${jwt.role-claim}") String roleClaim,
                                 ...
                                 @Value("${fr.insee.rmes.security.csrf.disable:false}")boolean disableCsrf) {
    ...
    @Bean
    public CorsConfigurationSource corsConfigurationSource(@Value("${fr.insee.rmes.apic.cors.allowed-origins}") Optional<String> allowedOrigin) {
