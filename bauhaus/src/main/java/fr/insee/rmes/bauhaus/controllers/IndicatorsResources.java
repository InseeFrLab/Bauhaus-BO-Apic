...
import fr.insee.rmes.bauhaus.model.Indicator;
...
public interface IndicatorsResources {
    ...
    @PreAuthorize("hasAnyRole(T(fr.insee.rmes.bauhaus.auth.Roles).ADMIN , T(fr.insee.rmes.bauhaus.auth.Roles).INDICATOR_CONTRIBUTOR)")
